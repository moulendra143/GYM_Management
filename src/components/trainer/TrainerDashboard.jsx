    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      >
        ...
        <h2 className="text-2xl font-bold mt-1">
          Welcome, Trainer Ravi
        </h2>
        <p className="text-sm mt-1 opacity-90">
          Manage members, workout plans, and track training progress.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        >
          ...
          <p className="text-sm opacity-90">Assigned Members</p>
          <h2 className="text-3xl font-bold mt-1">12</h2>
          <p className="text-sm mt-1 opacity-90">Active trainees</p>
        ...
        >
          ...
          <p className="text-sm mt-1 opacity-90">Plans created</p>
        ...
        >
          ...
          <p className="text-sm mt-1 opacity-90">Sessions this week</p>
      ...
      <div className="mb-3 flex justify-between items-center">
        ...
        <p className="text-sm text-gray-500">
          Access your common trainer tools quickly.
        </p>
      </div>
        ...
        >
          <div className="flex items-center gap-3">
            <div className="bg-orange-200 p-3 rounded-lg">
              <FaDumbbell className="text-orange-700" />
            </div>
            <div>
