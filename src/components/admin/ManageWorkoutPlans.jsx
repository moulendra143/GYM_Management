...
const ManageWorkoutPlans = () => {
  ...
  const [plans, setPlans] = useState([
    {
      id: 1,
      title: "Weight Loss Plan – Cardio + Light Weights",
      member: "John Doe",
      username: "john",
      date: "10 Dec 2025",
      time: "10:53",
      goal: "Fat loss with basic strength (5 days/week)",
      details: [
        "Day 1 & 3 – Cardio",
        "Treadmill – 5 min warm-up + 15 min jog/walk intervals",
        "Cross Trainer / Cycling – 15 min",
      ],
    },
    {
      id: 2,
      ...
      date: "10 Dec 2025",
      time: "10:51",
      goal: "Overall fitness, basic strength and stamina (3 days/week)",
      details: [
        "Day 1 – Full Body",
        "Warm-up – 5–10 min brisk walk / cycling",
  ...
  const filteredPlans =
    selectedMember === "All Members"
      ? plans
      : plans.filter((p) => p.member === selectedMember);
            ...
            <div key={plan.id} className="rounded-xl overflow-hidden border">
              ...
              <div className="bg-[#0f172a] text-white p-4 flex justify-between items-center">
                <div>
                  ...
                  <div className="text-xs flex items-center gap-3 mt-1 opacity-80">
                    <span className="flex items-center gap-1">
                      <FaCalendarAlt /> {plan.date}
                    </span>
                    <span>{plan.time}</span>
                  </div>
                </div>
                ...
                <div className="text-right text-xs">
                  ...
                  <div className="opacity-70">{plan.username}</div>
                </div>
              </div>
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    onClick={() =>
                      navigate(`/admin/view-workout-plan/${plan.id}`, {
                        state: { plan },
                      })
                    }
